            ...
            new ol.layer.Tile({
                source: new ol.source.XYZ({
                    ...
                    tileUrlFunction: function (coordinate) {
                        ...
                        const worldZoomFactorDivWorldTileSize = worldZoomFactor / worldTileSize;

                        const minTileX = Math.floor(worldMinX * worldZoomFactorDivWorldTileSize);
                        const minTileY = Math.floor(worldMinY * worldZoomFactorDivWorldTileSize);
                        const maxTileX = Math.ceil((worldMinX + worldWidth) * worldZoomFactorDivWorldTileSize) - 1;
                        const maxTileY = Math.ceil((worldMinY + worldHeight) * worldZoomFactorDivWorldTileSize) - 1;
